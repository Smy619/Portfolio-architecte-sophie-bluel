...
function switchToAddPhotoView() {
  ...
  document.getElementById("open-add-photo").addEventListener("click", switchToAddPhotoView);// Bouton pour ouvrir la vue d'ajout
  document.getElementById("return-to-gallery").addEventListener("click", switchToGalleryView);// Bouton pour retourner à la galerie
